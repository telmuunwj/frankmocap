...
class Predict:
  def __init__(self):
        ...
        #Set Mocap regressor
        self.body_mocap = BodyMocap(args.checkpoint_body_smplx, args.smpl_dir, device = device, use_smplx= True)
        self.hand_mocap = HandMocap(args.checkpoint_hand, args.smpl_dir, device = device)
